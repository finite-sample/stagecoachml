...
from stagecoachml.utils import LatencyProfiler, compare_stage_performance
...
def benchmark_batch_predictions(single_model, stagecoach_model, X_test, batch_sizes=[1, 10, 100, 1000]):
